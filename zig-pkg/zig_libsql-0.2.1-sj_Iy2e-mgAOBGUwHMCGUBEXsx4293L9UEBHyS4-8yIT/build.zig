...
pub fn build(b: *std.Build) void {
    ...
    // Engine C flags are independent of the consumer's Zig optimize mode:
    // always release-ish + no DWARF so Debug Zig apps do not pay multi-GB
    // debug-info costs for the amalgamation.
    ...
    // ReleaseFast on the stub module is a belt-and-suspenders match for -O2/-g0
    // on the C file; Zig code in the stub is empty.
    ...
    engine_mod.addIncludePath(b.path("vendor"));
